...
// Função para encontrar o maior e o menor valor na matriz
void encontrarMaiorMenor(float matriz[MAX][MAX], float& maior, float& menor) {
    maior = matriz[0][0];
    menor = matriz[0][0];
    for (int i = 0; i < MAX; ++i) {
        for (int j = 0; j < MAX; ++j) {
...
// Função para calcular a diferença das temperaturas da diagonal principal e secundária
...
int main() {
    ...
    while (true) {
        cout << "\nMenu:" << endl;
        cout << "1. Carregar matriz" << endl;
        cout << "2. Mostrar matriz" << endl;
        cout << "3. Calcular somatoria das temperaturas" << endl;
        cout << "4. Calcular media das temperaturas" << endl;
        cout << "5. Calcular maior e menor temperatura" << endl;
        cout << "6. Calcular maior temperatura da diagonal principal" << endl;
        cout << "7. Calcular media das temperaturas da diagonal secundaria" << endl;
        cout << "8. Calcular diferenca das temperaturas da diagonal principal e secundaria" << endl;
        ...
        switch (opcao) {
            ...
            case 2:
                ...
                break;
            case 3:
                cout << "Somatoria das temperaturas: " << calcularSomatoria(matriz) << endl;
                break;
            case 4:
                cout << "Media das temperaturas: " << calcularMedia(matriz) << endl;
                break;
            case 5:
                encontrarMaiorMenor(matriz, maior, menor);
            ...
            case 6:
                ...
                break;
            case 7:
                cout << "Media das temperaturas da diagonal secundaria: " << calcularMediaDiagonalSecundaria(matriz) << endl;
                break;
            case 8:
                cout << "Diferenca das temperaturas das diagonais: " << calcularDiferencaDiagonais(matriz) << endl;
                break;
            case 9:
